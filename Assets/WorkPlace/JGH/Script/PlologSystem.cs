...
public class PlologSystem : MonoBehaviour
{
    ...
    private List<DialogueLine> dialogues = new List<DialogueLine>
    {
        ...
        new DialogueLine
        {
            speaker = "강민준 박사", text = "아니, 박팀장님이 시키셨으면서 어떻게 가는 날까지 논리세요?",
        ...
        new DialogueLine
        {
            ...
            appear = new List<string> { "Gang" }, bgm = "None", sfx = "",
        ...
        new DialogueLine
        {
            ...
            appear = new List<string> { "Gang" }, bgm = "SyntheDrumMarsMellow", sfx = "", background = ""
        },
        new DialogueLine
        {
        ...
        {
            speaker = "강민준 박사",
            text = "손 쓸 수가…이대로 가다간 이 우주선은 버틸 수가 없을 꺼야. 어떻게 하지? 반드시…반드시 해결해야 해! 아, 혹시 개폐 시스템을 이용한다면!!",
            appear = new List<string> { "Gang" }, bgm = "", sfx = "", background = ""
        },
        new DialogueLine
        {
        ...
        new DialogueLine
        {
            speaker = "", text = "청컹 - !", appear = new List<string> { }, bgm = "", sfx = "Sfx_SpaceShipDoor",
            background = ""
        },
        ...
        new DialogueLine
        {
            ...
            appear = new List<string> { "Gang" }, bgm = "", sfx = "", background = "Images/Backgrounds/Falling_sector"
        },
        new DialogueLine
        {
            speaker = "", text = "촤아아아악!!", appear = new List<string> { "Gang" }, bgm = "", sfx = "Sfx_Parachute",
            background = ""
        },
        new DialogueLine
        {
